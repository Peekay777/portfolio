...
var projDetailCollection = [{
							...
							"Small Business" : [{
								"skills" : "HTML, CSS",
								"situation" : "Prototype a static landing page for a fictitious small business.  Application of key design concepts for user experience (UX) and along with it, user interfaces (UI's). ",
								"task" : "Initial strategy was to understanding the appeal of an architecture firm to their clients and how the client base is assembled. Using this information apply them to the UX design to capture the client’s interest. The client’s should instantly know they are viewing an architecture firm, see examples of their work and a short description about the business.",
								"action" : "The project was initial sketched and then wireframe; elements of the designed were discussed and revised before prototyping. The project went through a few until the final design.",
							...
							"Quiz App" : [{
								...
								"task" : "The quiz was on movies and there stars. The theme was based on the popular IMDB.com and synonymous with that genre. The idea was that a user would instantly recognise the general layout and know that the quiz was about movies. The functionality was designed to have the player and questions as objects with methods to show questions, keep score and progress in the game.",
								"action" : "The quiz was programmed to expand to more than the 5 question and not to be constrained by the limitation of the prototype.  The player progress and score is available on each page and feedback on answers correctness. Also as an extra requirement, a responsive design was applied to allow viewing in different browser resolutions.",
							...
							"Guessing Game" : [{
								...
								"situation" : "Complete the logic for a predesigned guessing game. The HTML and CSS are already completed and the assignment simulating what it is like to collaboratively work on a code base.",
							...
							"Shopping List" : [{
								...
								"situation" : "Build a shopping list that will allow a user can enter, check and remove items from a list.",
								"task" : "The design needed to consider the functionality as a priority and the visuals second. Once every functional element had been added a theme could be added to suggest that the list was for shopping (although the app could do other types of lists).",
							...
							"Stacker AJAX" : [{
								...
								"task" : "Researched the StackExchange API to understand the data available and design the response to the query. The response returned the name, picture and score of the answerer.",
								"action" : "Completed the JavaScript code for the app, using the Chrome’s Dev Tools to debug any issues and continued to iterate until complete.",
