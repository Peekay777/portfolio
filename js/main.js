...
$(document).ready(function() {
	...
	$("#projects").on("click", ".project", function() {
		...
		details.find("#skills").text(projDetailCollection2[pid].skills);
		details.find("#situation").text(projDetailCollection2[pid].situation);
		details.find("#task").text(projDetailCollection2[pid].task);
		details.find("#action").text(projDetailCollection2[pid].action);
		details.find("#result").text(projDetailCollection2[pid].result);
		details.find("#project-details-screeny").attr("href", projDetailCollection2[pid].link);
		details.find("#project-details-screeny").css("background-image", "url(images/" + projDetailCollection2[pid].screeny + ")");
		details.find("#gitlink").attr("href", projDetailCollection2[pid].gitlink);
